export const it = {
  ...
  contact: {
    title: "Hubungi Kami",
    subtitle: "Hubungi kami untuk konsultasi, penawaran harga, atau informasi lebih lanjut mengenai produk dan layanan kami.",
