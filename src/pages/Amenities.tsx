...
import { Flower as FlowerIcon, Dumbbell, Waves, PersonStanding, Utensils, Wine, Coffee, Clock, Car, Plane, Car as CarIcon, MapPin, Users, Music, BookOpen } from "lucide-react";
...
export default function Amenities() {
  ...
  const getIcon = (categoryName: string, index: number) => {
    const icons = {
      wellness: [<FlowerIcon key={0} />, <Dumbbell key={1} />, <Waves key={2} />, <PersonStanding key={3} />],
  ...
  return (
    <>
      <Helm
        content="Fasilitas dan layanan tenda membran Surabaya - Temukan berbagai fasilitas lengkap untuk acara Anda termasuk catering, dekorasi, sound system, dan layanan profesional lainnya."
        href="/amenities"
          ...
          <section className="relative py-20 bg-gradient-to-r from-sea-light to-white dark:from-sea-dark dark:to-background">
            <div className="container relative z-10 pt-20">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <h1 className="text-5xl md:text-3xl font-bold mt-2 mb-6">
