...
export default function Contact() {
    ...
    return (
        <>
            <Helm
                content="Hubungi kami untuk jasa pembuatan dan pemasangan tenda membran Surabaya. Konsultasi gratis, harga terbaik, dan layanan profesional untuk kebutuhan tenda membran Anda."
                href="/contact"
                title="Kontak Kami"
            />
