...
export default function ApartmentDetail() {
  ...
  if (!apartment) {
    return (
      <>
        <Helm
          content="Halaman tidak ditemukan - Tenda Membran Surabaya"
          href="/404"
  ...
  return (
    <>
      <Helm
        content={`Detail ${apartment.name} - Tenda membran berkualitas tinggi dengan ${apartment.capacity} kapasitas, ukuran ${apartment.size}m², dan lokasi ${apartment.location}.`}
        href={`/apartments/${id}`}
